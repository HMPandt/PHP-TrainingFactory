...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'instructeur', targetEntity: Lesson::class)]
    ...
    public function getPreprovision(): ?int
    {
        return $this->preprovision;
    }

    public function setPreprovision(int $preprovision): self
    {
